...
<?php require_once('header.php'); ?>
    ...
    <div class="container">
                    ...
                    <form id="login-form" method="POST">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" name="player_id" id="player-id" placeholder="Nhập ID tài khoản PUBG Mobile" class="input-field">
        ...
        <input type="hidden" name="game_id" value="PUBG">
        ...
        <div class="currency-section">
            <div class="list-currency">
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/uc.png" class="currency-icon">
                            <span class="currency-amount">3,600</span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/uc.png" class="currency-icon">
                            <span class="currency-amount">5,400</span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/uc.png" class="currency-icon">
                            <span class="currency-amount">18,000</span>
                        </div>
...
<!-- Mirrored from congnapthe.com/?game=PUBGMobile by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Jan 2025 19:53:40 GMT -->
</html>
