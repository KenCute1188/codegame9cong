                    ...
                    <form id="login-form" method="POST">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" name="player_id" id="player-id" placeholder="Nhập ID Valorant" class="input-field">
        ...
        <div class="currency-section">
            <div class="list-currency">
                        ...
                        <div class="currency-top">
                            ...
                            <span class="currency-amount">1,650</span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/vp1.png" class="currency-icon">
                            <span class="currency-amount">7,320</span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/vp1.png" class="currency-icon">
                            <span class="currency-amount">10,980</span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/vp1.png" class="currency-icon">
                            <span class="currency-amount">18,240</span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/vp1.png" class="currency-icon">
                            <span class="currency-amount">39,300</span>
                        </div>
...
<!-- Mirrored from congnapthe.com/?game=Valorant by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Jan 2025 19:53:41 GMT -->
</html>
