...
<?php require_once('header.php'); ?>
    ...
    <div class="container">
        <div class="game-banner" id="game-banner" style="background-image: url('../cdn-gop.garenanow.com/gop/mshop/www/live/assets/AOV-313c6659.jpg');">
            <div class="game-info">
                    ...
                    <form id="login-form" method="POST">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" name="player_id" id="player-id" placeholder="Nhập UID tài khoản Liên Quân Mobile" class="input-field">
        ...
        <input type="hidden" name="game_id" value="LienQuan">
    ...
    <div id="popup-thongbao" class="custom-popup-overlay" style="display: none;">
        <div class="custom-popup-content">
            <div class="custom-popup-header">
                <img class="custom-banner-img" src="../cdn-gop.garenanow.com/gop/mshop/www/live/assets/AOV-313c6659.jpg" alt="Game Banner">
...
<!-- Mirrored from congnapthe.com/?game=LienQuanMobile by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Jan 2025 19:53:39 GMT -->
</html>
