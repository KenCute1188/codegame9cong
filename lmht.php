    ...
    <div class="container">
        ...
        <?php if ($isLogin) { ?>
            ...
            <div class="login-container">
                ...
                <?php } ?>
                            ...
                            <div class="gift" style="background-image: url('images/gift/lmht-ahri-huyen-thoai-troi-day.png');">
                    <div class="bg">
                        <div class="simple-text">Nhận ngay trang phục</div>
                        <div class="highlight-text">Ahri Huyền Thoại Trỗi Dậy</div>
        ...
        <div class="currency-section">
            <div class="list-currency">
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/rp.png" class="currency-icon">
                            <span class="currency-amount">4,140 </span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/rp.png" class="currency-icon">
                            <span class="currency-amount">8,400 </span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/rp.png" class="currency-icon">
                            <span class="currency-amount">12,540 </span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/rp.png" class="currency-icon">
                            <span class="currency-amount">21,300 </span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/rp.png" class="currency-icon">
                                <span class="currency-amount">43,500 </span>
                        </div>
            ...
            <div class="card-selection">
                ...
                <div class="list-card">
                            ...
                            <img src="images/card/zing.png"
                                alt="Nạp Liên Minh Huyền Thoại bằng thẻ Zing">
                        </div>
                                            <div class="card-item" data-card="GATE">
                            <img src="images/card/gate.png"
                                alt="Nạp Liên Minh Huyền Thoại bằng thẻ Gate">
                        </div>
                                            <div class="card-item" data-card="VCOIN">
                            <img src="images/card/vcoin.png"
                                alt="Nạp Liên Minh Huyền Thoại bằng thẻ Vcoin">
                        </div>
                                    </div>
            </div>
...
<!-- Mirrored from congnapthe.com/?game=LMHT by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Jan 2025 19:53:44 GMT -->
</html>
