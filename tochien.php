    ...
    <div class="container">
        ...
        <?php if ($isLogin) { ?>
            ...
            <div class="login-container">
                    ...
                    <div class="form-label">
                        <div class="title-login">ID người chơi</div>
                        <div class="showGetUID">Hướng dẫn lấy ID</div>
                    </div>
                    <form id="login-form" method="POST">
                        <input type="hidden" name="_token" value="FiB0f9gTVihqVrYVRZo5e2qdqYUxqRpT9Px1wn1X" autocomplete="off">
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" name="player_id" id="player-id" placeholder="Nhập tài khoản Riot ID" class="input-field">
                ...
                <?php } ?>
                            ...
                            <div class="gift" style="background-image: url('images/gift/jinx-ve-binh-tinh-tu.png');">
                    <div class="bg">
                        <div class="simple-text">Nhận ngay trang phục</div>
                        <div class="highlight-text">Jinx Vệ Binh Tinh Tú</div>
        ...
        <div class="currency-section">
            <div class="list-currency">
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/wc.png" class="currency-icon">
                            <span class="currency-amount">3,000</span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/wc.png" class="currency-icon">
                            <span class="currency-amount">6,300</span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/wc.png" class="currency-icon">
                            <span class="currency-amount">9,300</span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/wc.png" class="currency-icon">
                            <span class="currency-amount">16,950</span>
                        </div>
                        ...
                        <div class="currency-top">
                            <img src="images/tiente/wc.png" class="currency-icon">
                            <span class="currency-amount">34,950</span>
                        </div>
...
<!-- Mirrored from congnapthe.com/?game=TocChien by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 12 Jan 2025 19:53:45 GMT -->
</html>
